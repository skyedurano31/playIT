...
@Dao
public interface FindItAttemptDao {
    @Insert(onConflict = OnConflictStrategy.REPLACE)
    suspend fun insert(attempt: FindItAttempt)

    @Query("SELECT * FROM find_it_attempt WHERE profileId = :profileId AND phonemeId = :phonemeId")
